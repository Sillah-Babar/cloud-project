...
# model= keras.models.load_model('drive/MyDrive/transformer_model/best_model.h5',compile=False)
...
#   vid_name=splitpaths[-1].split('.')

#   if(len(vid_name)>1 and vid_name[1]=='mp4'):
#     # align_path=""
#     # for i in range(8):
#     #     align_path+=splitpaths[i]+'\\'
#     # align_path+=vid_name[0]+'.align'
#     # print(align_path)
#     # align=Align(absolute_max_string_len, text_to_labels).from_file(align_path)
...
#     #referen=align.sentence
#     #print("Reference: ",referen)
#     print("Result: ",new_result)

#     # error = wer_sentence(referen, result[0])
#     # err = cer(referen, result[0])
